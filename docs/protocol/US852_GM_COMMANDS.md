...
| Wire | Body | Handling |
|---|---|---|
| `0x008f/10` | `u32 OID, u8 force` | disconnect target from the authoritative lobby |
| `0x008f/11` | `u32 OID` | disconnect target from the authoritative lobby |
...
| `0x008f/18` | `u32 OID, u32 type, u32 quantity` | catalog-validated durable grant transaction |
