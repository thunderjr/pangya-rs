...
pub use game::{
    ...
    RetailChannelJoined, RetailClientException, RetailFirstShotReady, RetailLoginBonusClaimResponse,
    RETAIL_LOGIN_BONUS_CLAIM_OPCODE, RetailLoginBonusItemGrant, RetailLoginBonusRequest,
    RetailLoginBonusStatus, RetailMessageServerList, RetailMessageServerListRequest,
    RetailNewSessionKey, RetailNewSessionKeyRequest, RetailPlayerHistory,
