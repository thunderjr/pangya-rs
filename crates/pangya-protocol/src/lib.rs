...
pub use us852_room::{
    ...
    RetailEquipmentUpdated, RetailHoleProgression, RetailLobbyEquipmentUpdate,
    ...
    RetailShopJoined, RetailTeam, RetailTeamChange, RetailTeamChangeAnnounce, RoomCensusKind,
